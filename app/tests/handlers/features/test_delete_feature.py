...
class TestDeleteFeatureHandler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.get_service_patcher = patch(
            "src.handlers.features.delete_feature.main.get_feature_service"
        )
    ...
    def test_delete_feature_success(
        ...
        response = delete_feature_handler(self.valid_event, context={})

        mock_get_user.assert_called_once_with(self.valid_event)
        mock_require_admin.assert_called_once_with(self.admin_user)
        self.mock_service.delete_feature.assert_called_once_with(
    ...
    def test_delete_feature_unauthorized(self, mock_get_user):
        ...
        self.mock_service.delete_feature.assert_not_called()
    ...
    def test_delete_feature_service_exception(
        ...
        self.mock_service.delete_feature.side_effect = Exception("boom")
