...
class TestDeleteFeatureEnvHandler(unittest.TestCase):
    ...
    @patch("src.handlers.features.delete_feature_env.main.get_current_user")
    @patch("src.handlers.features.delete_feature_env.main.require_admin")
    @patch("src.handlers.features.delete_feature_env.main.get_feature_service")
    @patch("src.handlers.features.delete_feature_env.main.success_response")
    def test_delete_feature_env_success(
        self,
        mock_success,
        mock_get_service,
        mock_require_admin,
        ...
        mock_service.remove_env.assert_called_once_with(
    ...
    @patch("src.handlers.features.delete_feature_env.main.get_current_user")
    def test_delete_feature_env_unauthorized(self, mock_get_user):
    ...
    @patch("src.handlers.features.delete_feature_env.main.get_current_user")
    @patch("src.handlers.features.delete_feature_env.main.require_admin")
    def test_delete_feature_env_not_admin(
    ...
    @patch("src.handlers.features.delete_feature_env.main.get_current_user")
    @patch("src.handlers.features.delete_feature_env.main.require_admin")
    def test_delete_feature_env_missing_flag(
        self, mock_require_admin, mock_get_user
    ):
        mock_get_user.return_value = {"role": "ADMIN"}
        mock_require_admin.return_value = None
    ...
    @patch("src.handlers.features.delete_feature_env.main.get_current_user")
    @patch("src.handlers.features.delete_feature_env.main.require_admin")
    def test_delete_feature_env_missing_env(
        self, mock_require_admin, mock_get_user
    ):
        mock_get_user.return_value = {"role": "ADMIN"}
        mock_require_admin.return_value = None
    ...
    @patch("src.handlers.features.delete_feature_env.main.require_admin")
    @patch("src.handlers.features.delete_feature_env.main.get_feature_service")
    def test_delete_feature_env_service_exception(
        ...
        mock_service = MagicMock()
        mock_service.remove_env.side_effect = Exception("boom")
        mock_get_service.return_value = mock_service
